...
## Замечания:
- 1: Не используйте IDREFб где можно сделать обычную вложенность, принятую в структурах
- 2: Попробуйте сделать минимальное количестово XML на одного юзера (их много)
- 3: Используйте StaxStreamProcessor! Добавляйте туде утильные методы.
